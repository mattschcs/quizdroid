...
class QuestionActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        questions = ArrayList(quizRepo.getQuestionsForTopic(subjectName)?: emptyList())
        questionTextView.text = questions!!.get(currentQuestionIndex).questionText
    ...
    private fun displayQuestion(targetQuestion: ArrayList<Question>,currentQuestionIndex: Int) {
        ...
        currentQuestion.answers.forEachIndexed { index: Int, option: String ->
    ...
    private fun navigateToAnswerPage(selectedAnswerIndex: Int, currentQuestionIndex: Int, correctAnswers: Int) {
        val correctAnswerIndex = questions!![currentQuestionIndex].correctQuestionIndex
